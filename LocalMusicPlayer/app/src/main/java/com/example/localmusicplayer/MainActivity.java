...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private MusicService.MusicControl myMusicControl;
    ...
    private void serviceConn() {
        serviceConnection = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
                myMusicControl = (MusicService.MusicControl) iBinder;

                //如果主activity启动时正在播放
                if(myMusicControl.getMediaPlayState()==1) {
                    playIv.setImageResource(R.mipmap.icon_pause);
                    songTv.setText(myMusicControl.getMusicSong());
                    singerTv.setText(myMusicControl.getMusicSinger());
                    currentId=myMusicControl.getMusicId();
                    //设置进度条大小
                    seekBar.setMax(myMusicControl.getMusicDuration());
                    Log.d("currentId", Integer.toString(currentId));
                }

                //传递播放列表
                myMusicControl.setDatas(MainData);
                ...
                seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
                    ...
                    public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
                        ...
                        if(b && currentId!=-1 &&currentId!=-2) {
                            myMusicControl.seekToPosition(seekBar.getProgress());
                ...
                runnable = new Runnable() {
                    ...
                    @Override
                    public void run() {
                        pos = myMusicControl.getPlayPosition();
    ...
    private void setEventListener() {
        ...
        albumIv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                myMusicControl.setPlayModule();
                if(myMusicControl.getPlayModule()){
                    Toast.makeText(MainActivity.this, "单曲循环", Toast.LENGTH_SHORT).show();
                    //albumIv.setImageResource(R.mipmap.icon_song2_loop_blue);
                    albumIv.setImageResource(R.drawable.aaa);
                } else {
...
//                }
    ...
    public void onClick(View view) {
        ...
        if (view.getId()==R.id.bottom_iv_play) {
            ...
            int state = myMusicControl.getMediaPlayState();
            if (state == 1) {
                myMusicControl.pauseMusic();
    ...
    private void initView() {
        ...
        objectAnimator = ObjectAnimator.ofFloat(albumIv,"rotation",0f,360.0f);
        objectAnimator.setDuration(10000);//动画旋转一周的时间为10秒
        objectAnimator.setInterpolator(new LinearInterpolator());
        objectAnimator.setRepeatCount(-1);//-1表示动画无限循环
